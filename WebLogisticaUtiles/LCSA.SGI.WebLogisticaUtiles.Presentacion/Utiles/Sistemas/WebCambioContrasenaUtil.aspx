<%@ Page Language="C#" MasterPageFile="~/MasterPage/AppMenu.Master" AutoEventWireup="true" CodeBehind="WebCambioContrasenaUtil.aspx.cs" Inherits="LCSA.SGI.WebLogisticaUtiles.Presentacion.Utiles.Sistema.WebCambioContrasenaUtil" Title="Modulo Utiles - Cambio de Contraseña" %>
