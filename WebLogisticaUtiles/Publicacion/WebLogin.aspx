<%@ Page Language="C#" MasterPageFile="~/MasterPage/AppMaster.Master" AutoEventWireup="true" CodeBehind="WebLogin.aspx.cs" Inherits="LCSA.SGI.WebLogisticaUtiles.Presentacion.WebLogin" Title="Página sin título" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="text-align: center">
                                    <br />
                                    <br />
                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/freeway.gif" />
                                    <br />
                                    <br />
